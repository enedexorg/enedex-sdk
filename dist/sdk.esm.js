...
(function (ChainId) {
  ...
  ChainId[ChainId["MOONBEAM_TEST"] = 1287] = "MOONBEAM_TEST";
  ChainId[ChainId["BINANCE_TEST"] = 97] = "BINANCE_TEST";
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MAINNET] = '0x0000000000000000000000000000000000000000', _FACTORY_ADDRESS[ChainId.MOONBEAM_TEST] = '0xFC628dd79137395F3C9744e33b1c5DE554D94882', _FACTORY_ADDRESS[ChainId.BINANCE_TEST] = '0xe1C915aBa8c97aD03E2803F744302783F7D81324', _FACTORY_ADDRESS[ChainId.ROPSTEN] = '0x2F4a92dE564238dAf88774E5DE6d3d6A7d9Bb4D1', _FACTORY_ADDRESS);
var INIT_CODE_HASH = '0x746d1476e7e73be45baf2f3a541aaaa3b58699ca9c3665f8107c13f36ebe1c12';
...
Currency.BASE_CURRENCY = (_Currency$BASE_CURREN = {}, _Currency$BASE_CURREN[ChainId.MAINNET] = /*#__PURE__*/new Currency(ChainId.MAINNET, 18, 'ETH', 'Ether'), _Currency$BASE_CURREN[ChainId.ROPSTEN] = /*#__PURE__*/new Currency(ChainId.ROPSTEN, 18, 'ETH', 'Ether'), _Currency$BASE_CURREN[ChainId.MOONBEAM_TEST] = /*#__PURE__*/new Currency(ChainId.MOONBEAM_TEST, 18, 'GLMR', 'Glimmer'), _Currency$BASE_CURREN[ChainId.BINANCE_TEST] = /*#__PURE__*/new Currency(ChainId.BINANCE_TEST, 18, 'BNB', 'Binance Coin'), _Currency$BASE_CURREN);
var BASE_CURRENCY = Currency.BASE_CURRENCY;
...
var WRAPPED = (_WRAPPED = {}, _WRAPPED[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped Ether'), _WRAPPED[ChainId.ROPSTEN] = /*#__PURE__*/new Token(ChainId.ROPSTEN, '0x02d4418C5eeb5BeF366272018F7cD498179FE98B', 18, 'WETH', 'Wrapped Ether'), _WRAPPED[ChainId.MOONBEAM_TEST] = /*#__PURE__*/new Token(ChainId.MOONBEAM_TEST, '0xb09bCc172050fBd4562da8b229Cf3E45Dc3045A6', 18, 'WGLMR', 'Wrapped Glimmer'), _WRAPPED[ChainId.BINANCE_TEST] = /*#__PURE__*/new Token(ChainId.BINANCE_TEST, '0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd', 8, 'WBNB', 'Wrappeed BNB'), _WRAPPED);
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  /**
   * Helper that calls the constructor with the BASE_CURRENCY currency
   * @param amount ether amount in wei
   */


  CurrencyAmount.base = function base(chainId, amount) {
    return new CurrencyAmount(BASE_CURRENCY[chainId], amount);
  };
...
var Price = /*#__PURE__*/function (_Fraction) {
  ...
  _proto.quote = function quote(chainId, currencyAmount) {
    ...
    return CurrencyAmount.base(chainId, _Fraction.prototype.multiply.call(this, currencyAmount.raw).quotient);
  };
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === BASE_CURRENCY[pairs[0].chainId] && pairs[0].involvesToken(WRAPPED[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === BASE_CURRENCY[pairs[0].chainId] && pairs[pairs.length - 1].involvesToken(WRAPPED[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
    var path = [input instanceof Token ? input : WRAPPED[pairs[0].chainId]];
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === BASE_CURRENCY[route.chainId] ? CurrencyAmount.base(route.chainId, amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === BASE_CURRENCY[route.chainId] ? CurrencyAmount.base(route.chainId, amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
  ...
  _proto.minimumAmountOut = function minimumAmountOut(chainId, slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_OUTPUT) {
      ...
      return this.outputAmount instanceof TokenAmount ? new TokenAmount(this.outputAmount.token, slippageAdjustedAmountOut) : CurrencyAmount.base(chainId, slippageAdjustedAmountOut);
    }
  }
  /**
  ...
  _proto.maximumAmountIn = function maximumAmountIn(chainId, slippageTolerance) {
    !!slippageTolerance.lessThan(ZERO) ? process.env.NODE_ENV !== "production" ? invariant(false, 'SLIPPAGE_TOLERANCE') : invariant(false) : void 0;
    ...
    if (this.tradeType === TradeType.EXACT_INPUT) {
      ...
      return this.inputAmount instanceof TokenAmount ? new TokenAmount(this.inputAmount.token, slippageAdjustedAmountIn) : CurrencyAmount.base(chainId, slippageAdjustedAmountIn);
    }
  }
  /**
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency === BASE_CURRENCY[trade.route.chainId];
    var etherOut = trade.outputAmount.currency === BASE_CURRENCY[trade.route.chainId]; // the router does not support both ether in and out

    !!(etherIn && etherOut) ? process.env.NODE_ENV !== "production" ? invariant(false, 'BASE_CURRENCY_IN_OUT') : invariant(false) : void 0;
    !(!('ttl' in options) || options.ttl > 0) ? process.env.NODE_ENV !== "production" ? invariant(false, 'TTL') : invariant(false) : void 0;
    var to = validateAndParseAddress(options.recipient);
    var amountIn = toHex(trade.maximumAmountIn(trade.route.chainId, options.allowedSlippage));
    var amountOut = toHex(trade.minimumAmountOut(trade.route.chainId, options.allowedSlippage));
...
export { BASE_CURRENCY, ChainId, Currency, CurrencyAmount, FACTORY_ADDRESS, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WRAPPED, currencyEquals, inputOutputComparator, tradeComparator };
